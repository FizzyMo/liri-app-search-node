...
function concert(inputs) {
	...
	request(queryUrl, function(error, data) {
		...
		if (!error && data.statusCode === 200) {
			...
			console.log("Name of venue: " + arr [i] .venue.name);
			console.log("Venue location: " + arr [i] .venue.city);
			console.log("Date of the Event: " + moment (arr[i].datetime).format("MM/DD/YYYY"));
		}}
	});
};
